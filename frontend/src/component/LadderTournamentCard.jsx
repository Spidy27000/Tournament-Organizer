...
const LadderTournamentCard = ({ data }) => {
  ...
  return (
    <>
      <div
        className="hover:scale-105 transition-all hover:shadow-lg w-[32%] flex flex-col gap-8 h-[14rem] cursor-pointer border-[0.08rem] p-4 bg-[#f6f4f0] rounded-xl shadow-md"
